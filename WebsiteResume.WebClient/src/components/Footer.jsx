...
import { AccountTree, Copyright, GitHub, Home, LinkedIn } from "@mui/icons-material";
    ...
    return (
        <AppBar position="static" sx={{ top: 'auto', bottom: '0', backgroundColor: '#333333' }}>
            <Toolbar>
                ...
                <Tooltip title='LinkedIn' sx={{ pt: 1 }}>
                    <Link to='https://www.linkedin.com/in/alexander-rozsa/' target="_blank" rel="noopener noreferrer">
                        <LinkedIn sx={{ mt: '5px' }} />
                    </Link>
                </Tooltip>
            </Toolbar>
